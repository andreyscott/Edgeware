              ...
              <div>
                ...
                <div className="space-y-6 mb-12">
                  ...
                  <div className="flex gap-4 group">
                    <div className="shrink-0 w-12 h-12 rounded-xl bg-brand-navy flex items-center justify-center group-hover:bg-brand-gold transition-colors duration-300">
                  ...
                  <ul className="space-y-3 relative z-10">
                    {[
                      ...
                      <li key={reason} className="flex items-center gap-3">
                        <div className="shrink-0 w-4 h-4 rounded-full bg-brand-gold/20 border border-brand-gold/40 flex items-center justify-center">
